...
function Task() {
  ...
  const handleSubmit = (event) => {
    ...
    if (summary.split(" ").length < 100 || summary.split(" ").length > 150) {
        alert("Summary must be between 100 and 150 words.");
    } else {
        navigate("/post");
    } 
  };

const wordCount =  summary.split(" ").filter((word) => word !== "").length;

return (
    <Layout>
        <div id="main-container">
            <div id="task-text-container">
                <h2>Task Text</h2>
                <div id="task-text">
            ...
            <form id="summary-container" onSubmit={handleSubmit}>
                <label id="summary-instruction" htmlFor="summary">
                    In the box below, summarize the Task Text in 100 to 150 words.
                </label>
                <textarea
                    id="summary"
                    value={summary}
                ...
                />
                <div id="word-count">{wordCount} words</div>
